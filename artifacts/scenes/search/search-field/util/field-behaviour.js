    ...
    NUMBER: (__, searchField, restrictionMap, userMetrics) => (value) => {
        if (searchField.name === 'HeightRange') {
            if (userMetrics === 'Imperial') {
                const from = UnitConverter.heightImperialToMetric({ ft: value[0], inches: 0 });
                const to = UnitConverter.heightImperialToMetric({ ft: value[1], inches: 0 });
                value = [from, to];
            }
...
//# sourceMappingURL=field-behaviour.js.map