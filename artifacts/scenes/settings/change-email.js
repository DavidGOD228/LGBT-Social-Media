...
export default class ChangeEmailScreen extends BaseScreenDefault {
    constructor(props) {
        super(props);
        ...
        this.state = Object.assign({}, this.state, { email: '', error: {} });
    }
    render() {
        return (React.createElement(View, { style: styles.container },
            ...
            React.createElement(View, { style: styles.content },
                ...
                React.createElement(TextLight, { style: styles.title }, i18n.t('changeEmail.screenTitle')),
                ...
                React.createElement(KeyboardAvoidingView, { behavior: "position", keyboardVerticalOffset: 43 },
                    React.createElement(Input, { placeholder: i18n.t('common.placeholder.email'), keyboardType: 'email-address', autoCapitalize: 'none', onChangeText: this.emailChanged, textColor: this.state.error.email ? 'rgb(213, 0, 0)' : undefined, baseColor: this.state.error.email ? 'rgb(213, 0, 0)' : undefined })),
                this.state.error.email ? (React.createElement(UiBlockBasic, null,
                    React.createElement(UiBlockSpace, { height: 20 }),
                    React.createElement(TextBold, { style: styles.errorText }, this.state.email ? this.state.error.email.join('\n') : i18n.t('registration.error.form')))) : (null)),
...
], ChangeEmailScreen.prototype, "accountService", void 0);
