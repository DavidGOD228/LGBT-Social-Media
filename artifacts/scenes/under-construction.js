...
export default class UnderConstructionScreen extends BaseScreenDefault {
    constructor() {
        super(...arguments);
        this.backButton = () => {
    ...
    render() {
        return (React.createElement(View, { style: styles.container },
            ...
            React.createElement(Text, { style: styles.title }, i18n.t('underConstruction.title')),
...
UnderConstructionScreen.navigationOptions = {
