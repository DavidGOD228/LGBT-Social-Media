...
let FlexService = class FlexService extends ProfileInteractionToggleService {
    prepareConnection() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                this.subscription = yield this.rabbitCredentialService.subscribe('PROFILE_WAS_FLEXED', message => this.handleNewFlex(message));
            }
            catch (error) {
                console.log(error);
            }
...
], FlexService.prototype, "profileService", void 0);
__decorate([
    lazy('RabbitCredentialService'),
    __metadata("design:type", RabbitCredentialService)
], FlexService.prototype, "rabbitCredentialService", void 0);
__decorate([
...
], FlexService.prototype, "prepareConnection", null);
