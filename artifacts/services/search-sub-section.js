...
let SearchSubSectionService = class SearchSubSectionService extends DefaultBaseService {
};
SearchSubSectionService = __decorate([
    injectable(),
    listener('SearchSubSection'),
    mixin([LogoutClearable])
], SearchSubSectionService);
export { SearchSubSectionService };
