...
let ProfileViewFieldService = class ProfileViewFieldService extends DefaultBaseService {
};
ProfileViewFieldService = __decorate([
    injectable(),
    listener('ProfileViewField'),
    mixin([LogoutClearable])
], ProfileViewFieldService);
export { ProfileViewFieldService };
