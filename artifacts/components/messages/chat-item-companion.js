...
export default class ChatItemCompanion extends Component {
    constructor(props) {
        super(props);
        this.togglePicture = () => {
    ...
    render() {
        return (React.createElement(UiBlockBasic, null,
            ...
            React.createElement(UiBlockLeft, null,
                React.createElement(TouchableOpacity, { onPress: this.props.userPress },
                ...
                React.createElement(NCView, { style: styles.messageBaloonContainer },
                    ...
                    React.createElement(Image, { style: styles.borderArrow, resizeMode: 'stretch', source: require('Musl/images/messages/arrow-white.png') }))),
            React.createElement(UiBlockSpace, { height: 10 })));
    }
}
...
//# sourceMappingURL=chat-item-companion.js.map