...
class WeightInputImperialStateful extends Component {
    constructor(props) {
        super(props);
        ...
        return (React.createElement(View, { style: styles.rightContent },
            ...
            React.createElement(UiBlockBasic, null,
                React.createElement(UiBlockBottom, null,
                    React.createElement(TextNormal, { style: styles.metrics }, "lbs")))));
    }
    persistWeight() {
        if (!this.state.value) {
            return;
...
], WeightInputImperialStateful.prototype, "persistWeight", null);
const WeightInputImperial = ({ fieldData, persist, metrics }) => (React.createElement(WeightInputImperialStateful, { fieldData: fieldData, metrics: metrics, persist: persist }));
...
//# sourceMappingURL=weight-input-imperial.js.map