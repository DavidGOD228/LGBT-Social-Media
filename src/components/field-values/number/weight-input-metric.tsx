...
class WeightInputMetricStateful extends Component<Props, State> {
  constructor(props) {
    super(props)
    this.state = {
      ...this.state,
  ...
  render() {
    return (
      <View style={styles.rightContent}>
        ...
        <UiBlockBasic>
          <UiBlockBottom>
            <TextNormal style={styles.metrics}>kg</TextNormal>
          </UiBlockBottom>
        </UiBlockBasic>
      </View>
    )
...
const WeightInputMetric = ({fieldData, persist, metrics}: Props) => (
  <WeightInputMetricStateful fieldData={fieldData} metrics={metrics} persist={persist}/>
)
